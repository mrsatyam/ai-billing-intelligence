...
0. **Capstone deck** `/capstone` — 5 slides (guidelines: context → gaps → vision → solution → business flow)  
0b. **Demo pitch** `/presentation` — 8 slides (problem → how AI helps → click path)  
